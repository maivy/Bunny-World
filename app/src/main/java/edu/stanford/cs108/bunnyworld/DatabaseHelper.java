...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "BunnyWorldExtensionsDB.db";
    ...
    private static final String PRELOAD_SHAPES = "INSERT INTO shapes VALUES " +
            "(NULL,'doorbacktomain',3,1,'on click goto page1;','No Image','',0,0,0,140.14038,931.5625,141.09863,132.03125)," +
            "(NULL,'win-carrot2',5,1,'','carrot','',0,0,0,128.21265,121.23047,252.0,300.0)," +
            "(NULL,'doortodeathbunny',2,1,'on click goto deathbunny;','No Image','',0,0,0,762.6703,889.0332,197.16125,192.60742)," +
            "(NULL,'page1text',2,1,'','No Image','You are in a maze of twisty little\npassages, all alike',45,0,0,37.971924,664.39453,0.0,0.0)," +
            "(NULL,'shape15',5,1,'on enter play hooray;','No Image','You Win! Yay!',100,0,0,238.97339,893.5547,0.0,0.0)," +
            "(NULL,'escapedoor',1,1,'on click goto mysticbunny;','No Image','',0,0,0,287.02728,869.4478,122.56653,130.245)," +
            "(NULL,'doortomysticbunny',2,1,'on click goto mysticbunny;','No Image','',0,0,0,88.576965,892.041,197.1283,191.11328)," +
            "(NULL,'shape12',5,1,'','carrot','',0,0,0,413.47266,410.83008,252.0,300.0)," +
            "(NULL,'shape11',4,1,'','No Image','You must appease the bunny of death!',60,0,0,16.974121,861.5039,0.0,0.0)," +
            "(NULL,'exit',4,1,'on click goto wingame;','No Image','',0,1,0,861.28357,940.5957,161.10474,152.01172)," +
            "(NULL,'door2',2,1,'on click goto fireroom;','No Image','',0,1,0,422.7565,888.0078,202.77203,193.63281)," +
            "(NULL,'evilbunny',4,1,'on enter play evillaugh; on drop firecarrot hide firecarrot play munching hide evilbunny show exit;on click play evillaugh;','death','',0,0,0,233.38586,70.72266,654.22925,643.125)," +
            "(NULL,'shape8',1,1,'','No Image','Eek! Fire-Room. Run away!',50,0,0,48.801514,817.5,0.0,0.0)," +
            "(NULL,'wincarrot3',5,1,'','carrot','',0,0,0,745.76514,159.25781,252.0,300.0)," +
            "(NULL,'firecarrot',1,1,'','carrot','',0,0,1,718.7388,743.5547,252.0,300.0)," +
            "(NULL,'mystictext',3,1,'','No Image','Mystic Bunny! Rub my tummy for a big surprise!',50,0,0,18.971924,749.47266,252.0,300.0)," +
            "(NULL,'fire',1,1,'on enter play fire;','fire','',0,0,0,74.95941,61.453125,905.93555,601.66406)," +
            "(NULL,'mysticshape',3,1,'on click hide firecarrot play munching;on enter show door2;','mystic','',0,0,0,312.97192,102.75,459.0,567.0)," +
            "(NULL,'bunnyworldsign',2,1,'','No Image','Bunny World!',100,0,0,29.27295,116.13281,0.0,0.0)" +
            ";";
